...
public class ChangeFailure3 extends Application {
    ...
    @Override
    public void start(Stage primaryStage) {         //密码不一致报错
        GridPane pane = new GridPane();
        pane.setAlignment(Pos.CENTER);

        Text text1 = new Text("修改密码失败，前后两次密码不一致");
        text1.setFont(Font.font(25));
        Text text2 = new Text("3秒钟后回到修改密码界面");
