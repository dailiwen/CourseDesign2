...
public class DepositFailure1 extends Application {
    ...
    @Override
    public void start(Stage primaryStage) {         //存款失败，不为100倍数
        GridPane pane = new GridPane();
        pane.setAlignment(Pos.CENTER);

        Text text1 = new Text("存款失败，输入必须为100的倍数且不能为负数");
        text1.setFont(Font.font(25));
        Text text2 = new Text("3秒钟后回到存款界面");
